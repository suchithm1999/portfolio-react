function Experience() {
  return (
    <>
      <div
        id="work-experience"
        className="h-full w-full flex flex-col bg-map-image bg-no-repeat bg-cover items-center p-14 pt-12 m-8 mx-auto max-lg:hidden"
      >
        <span className="text-4xl font-bold">Work Experience</span>
        <div className="w-4/5">
          <div className="flex flex-col gap-2 items-center justify-between mt-12">
            <div className="flex justify-between w-full font-semibold text-xl">
              <span className="">SURYA DIGITECH PRIVATE LIMITED</span>
              <span>July 2022 - Present</span>
            </div>
            <span className="w-full text-blue-700 font-semibold text-base">
              Software Development Engineer 1
            </span>
            <div className="w-full">
              <ul
                style={{ listStyleType: "disc" }}
                className="text-lg font-normal text-gray-950 flex flex-col gap-2 mt-0"
              >
                <li>
            ...
            <span className="text-lg w-full font-bold text-gray-700 mt-2">
              Additional Projects:
            </span>
            <div className="w-full">
              <div>
          ...
          <div className="border border-b-gray-300 p-2 my-4 border-x-0 border-t-0"></div>
          <div className="flex flex-col gap-2 items-center justify-between mt-12">
            <div className="flex justify-between w-full font-semibold text-xl">
